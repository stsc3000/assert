define([], function() {
  ...
  function isType(value, T, errors) {
    ...
    if (T instanceof $traceurRuntime.GenericType && T.type === Array) {
      var types = T.argumentTypes.map((function(argumentType) {
        return assert[argumentType.name] || argumentType;
      }));
      return assert(value).is(($__5 = assert).arrayOf.apply($__5, $traceurRuntime.toObject(types)));
    }
